...
int d1=5;//this will be allocated in the data region of the memory
char*str1=NULL;
int *ptr=0x0000000a;
char *p2=NULL;
struct page*p1=NULL;
...
printk(KERN_ALERT " Main Module Is loaded");    ///printk() function is defined in the linux  kernel and made available to modules,it behaves similarly
pr_debug("My first static module is loaded sucessfully\n");
...
pr_debug("My first static module is unloaded sucessfully\n");
 
//but it is permament storage.  
__free_page(p1);
}
EXPORT_SYMBOL_GPL(d1);

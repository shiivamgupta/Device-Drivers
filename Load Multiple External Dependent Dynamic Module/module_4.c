...
extern int new_symbol;//this will be allocated in the data region of the memory
char*str1=NULL;
int *ptr2=0x0000000a;
char *p2=NULL;
struct page*p1=NULL;
...
//Special macro which is also function internally is used to tell the  kernel that this modulebears free licence
...
printk(KERN_ALERT "Dependent Module Is loaded");    ///printk() function is defined in the linux  kernel and made available to modules,it behaves similarly

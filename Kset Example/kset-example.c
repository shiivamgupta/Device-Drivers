...
//we have a pointer to a kobject{}, in a foo_obj{} 
...
//and basic attribute object - in addition, third parameter is pointer 
			     ...
			     char *buf)
{
	...
	struct foo_obj *foo;
        ...
        //dump_stack();
        //based on the basic attribute object, 
        //extract the device specific attribute object of 
        //the device instance 
	attribute = to_foo_attr(attr);
        //based on the kobject{}, extract the specific device object 
	...
	if (!attribute->show)
        ...
        //pass device object, device specific attribute object , and ptr to buffer,
        //as parameters 
...
static struct foo_attribute foo_attribute =
	__ATTR(dev_param1, 0664, foo_show, foo_store);
...
static struct foo_attribute baz_attribute =
	__ATTR(dev_param2, 0664, b_show, b_store);
static struct foo_attribute bar_attribute =
	__ATTR(dev_param3, 0664, b_show, b_store);
...
static int example_init(void)
{
	 ...
	 */
        ...
        //p2 is the system kobject, which will be the parent kobject
	 ...
	 */
        //
        //we are creating three dummy device objects containing 
